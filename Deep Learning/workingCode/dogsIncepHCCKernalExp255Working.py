...
# this function gets the z' sub i, which means the super pixel is present or missing
...
# I changed the background to 255. If a superpixel is missing, it takes the value of 255 as the background 
# if I dont' give a background, it will take a mean of the superpixel as the background

explainer = shap.KernelExplainer(f, np.zeros((1,50)))

shap_values = explainer.shap_values(np.ones((1,50)), nsamples=1000)
# find the shap values for each super pixel
