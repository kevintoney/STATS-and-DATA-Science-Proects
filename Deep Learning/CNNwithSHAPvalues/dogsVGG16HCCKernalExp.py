...
plot_model(model, to_file='model_plotKern.png', show_shapes=True, show_layer_names=True)
...
model.load_weights('./base.modelK')
...
plt.savefig('./shapValuesKernal.png')