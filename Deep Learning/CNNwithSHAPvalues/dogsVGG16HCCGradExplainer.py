...
model.load_weights('./base.modelG')
...
e = shap.GradientExplainer((model.layers[2].get_input_at(1), model.layers[-1].output), map2layer(preprocess_input(x_train.copy()), 2, 1))
shap_values,indexes = e.shap_values(map2layer(x_test[1:3], 2, 1), ranked_outputs=2)


# plot the explanations
shap.image_plot(shap_values, x_test[1:3])
plt.savefig('./shapValuesGradi.png')