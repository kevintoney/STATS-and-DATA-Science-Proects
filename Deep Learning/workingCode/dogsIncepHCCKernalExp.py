...
plot_model(model, to_file='model_plotKernInc.png', show_shapes=True, show_layer_names=True)
...
model.load_weights('./base.modelKInc')
...
# but the example was right in using 255. 
...
plt.savefig('./shapValuesKernalIncep.png')