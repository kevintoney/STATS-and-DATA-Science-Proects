...
plot_model(model, to_file='model_plotKernIncOnes.png', show_shapes=True, show_layer_names=True)
...
csvlogger = CSVLogger(
    filename= "training_csvKIncOnes.log",
    separator = ",",
    append = False
)
...
model.load_weights('./base.modelKIncOnes')
...
# I added sigma=3 to make it consistent with the running example
...
# I changed the background to 1 instead of 255 at first 
# but the example seems to be right in using 255. 
...
plt.savefig('./shapValuesKernalIncepOnes.png')